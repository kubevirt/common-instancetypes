	...
	Context("VirtualMachine using a preference is able to boot", func() {
		...
		DescribeTable("a Linux guest with", func(containerDisk string, preferences map[string]string, testFns []testFn) {
			...
			Entry("[test_id:10744] CentOS Stream 8", centosStream8ContainerDisk, map[string]string{"amd64": "centos.stream8"},
				[]testFn{expectGuestAgentToBeConnected, expectSSHToRunCommandOnLinux("centos")}),
			Entry("[test_id:10745] CentOS Stream 9", centosStream9ContainerDisk, map[string]string{"amd64": "centos.stream9"},
			...
			Entry("[test_id:10742] Ubuntu 20.04", ubuntu2004ContainerDisk, map[string]string{"amd64": "ubuntu"},
				[]testFn{expectSSHToRunCommandOnLinux("ubuntu")}),
			Entry("[test_id:10743] Ubuntu 22.04", ubuntu2204ContainerDisk, map[string]string{"amd64": "ubuntu"},
				[]testFn{expectSSHToRunCommandOnLinux("ubuntu")}),
			Entry("[test_id:TODO] Ubuntu 24.04", ubuntu2404ContainerDisk, map[string]string{"amd64": "ubuntu"},
				[]testFn{expectSSHToRunCommandOnLinux("ubuntu")}),
			...
			Entry("[test_id:TODO] OpenSUSE Leap 15", openSUSELeap15ContainerDisk, map[string]string{"amd64": "opensuse.leap"},
				[]testFn{expectGuestAgentToBeConnected, expectSSHToRunCommandOnLinux("opensuse")}),
