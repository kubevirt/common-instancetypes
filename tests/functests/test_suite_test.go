...
const (
	...
	defaultSLESContainerDisk               = "registry:5000/sles-container-disk:latest"
...
func init() {
	...
	flag.StringVar(&slesContainerDisk, "sles-container-disk",
		defaultSLESContainerDisk, "SLES container disk used by functional tests")
